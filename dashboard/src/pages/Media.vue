<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">مكتبة الوسائط</h1>
        <p class="text-gray-600 dark:text-gray-400 mt-1">إدارة الصور والفيديوهات والملفات</p>
      </div>
