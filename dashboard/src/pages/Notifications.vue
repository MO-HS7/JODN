  ...
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-gray-600 dark:text-gray-400 mt-1">جميع إشعارات النظام</p>
      </div>
    ...
    <div class="space-y-3">
      ...
      <div v-if="filteredNotifications.length === 0" class="dashboard-card text-center py-12">
        ...
        <p class="text-gray-600 dark:text-gray-400">لم يتم العثور على إشعارات في هذه الفئة</p>
      </div>
    </div>
  </div>
</template>
...
const filters = [
  ...
  { id: 'unread', name: 'غير مقروءة', count: 5 },
  { id: 'volunteer', name: 'المتطوعين', count: 2 },
  { id: 'project', name: 'المشاريع', count: 3 },
  { id: 'system', name: 'النظام', count: 3 }
]
