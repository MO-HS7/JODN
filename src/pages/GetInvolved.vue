<template>
  <div class="get-involved-page">
    ...
    <!-- Donate Section -->
    <section id="donate" class="section-padding bg-white">
      <div class="container-custom">
        <div class="max-w-4xl mx-auto">
          <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold text-brand mb-4">تبرع الآن</h2>
            <p class="text-gray-600 max-w-2xl mx-auto">
              تبرعك يساعدنا في تحسين حياة المجتمعات الريفية
            </p>
          </div>

          <div class="bg-gradient-to-br from-cream to-white rounded-2xl shadow-xl p-8 md:p-12">
            ...
            <div class="mb-6">
              ...
              <input
                ...
                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand"
              />
            </div>
            ...
            <div class="mb-6">
              ...
              <div class="flex gap-4">
                <label class="flex-1 flex items-center gap-3 p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-brand transition-colors">
                  <input v-model="donationType" type="radio" value="once" class="w-4 h-4 text-brand" />
                  <span class="font-semibold">مرة واحدة</span>
                </label>
                <label class="flex-1 flex items-center gap-3 p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-brand transition-colors">
                  <input v-model="donationType" type="radio" value="monthly" class="w-4 h-4 text-brand" />
                  <span class="font-semibold">شهري</span>
                </label>
              </div>
            </div>
    ...
    <section class="section-padding bg-cream">
      <div class="container-custom">
        <div class="text-center mb-12">
          <h2 class="text-3xl md:text-4xl font-bold text-brand mb-4">فرص التطوع</h2>
          <p class="text-gray-600 max-w-2xl mx-auto">
