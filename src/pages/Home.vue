        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
          <div class="order-2 lg:order-1">
            ...
            <div class="space-y-4 mb-8">
              ...
              <div class="flex items-start gap-3">
                ...
                <div>
                  <h4 class="font-bold text-gray-800">رسالتنا</h4>
                  <p class="text-gray-600 text-sm">تمكين المزارعين اقتصاديًا ودعم المرأة الريفية وتعزيز السلام المجتمعي</p>
                </div>
              </div>
            </div>
          ...
          <div class="order-1 lg:order-2">
            <div class="relative">
              ...
              />
              <div class="absolute -bottom-6 -right-6 bg-gold text-brand p-6 rounded-xl shadow-xl">
