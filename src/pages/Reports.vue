    ...
    <section class="section-padding bg-white">
      <div class="container-custom">
        <div class="text-center mb-12">
          <h2 class="text-3xl md:text-4xl font-bold text-brand mb-4">تقاريرنا</h2>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <div class="relative h-48 overflow-hidden">
              ...
              />
              <div class="absolute top-4 right-4 bg-gold text-brand px-3 py-1 rounded-full text-sm font-bold">
                {{ report.year }}
              </div>
            </div>
            ...
            <!-- Content -->
            <div class="p-6">
              <h3 class="text-xl font-bold text-brand mb-2">{{ report.title }}</h3>
              <p class="text-gray-600 text-sm mb-4">{{ report.description }}</p>
    ...
    <section class="section-padding bg-cream">
      <div class="container-custom">
        <div class="max-w-4xl mx-auto text-center">
          ...
          <h2 class="text-3xl md:text-4xl font-bold text-brand mb-6">التزامنا بالشفافية</h2>
          ...
          <div class="grid md:grid-cols-3 gap-6">
            <div class="bg-white p-6 rounded-xl shadow-md">
              ...
              <div class="text-gray-600">شفافية مالية</div>
            </div>
            <div class="bg-white p-6 rounded-xl shadow-md">
              <div class="text-4xl font-bold text-brand mb-2">{{ reports.length }}</div>
              <div class="text-gray-600">تقرير منشور</div>
            </div>
            <div class="bg-white p-6 rounded-xl shadow-md">
              <div class="text-4xl font-bold text-brand mb-2">4</div>
              <div class="text-gray-600">تقارير سنوية</div>
            </div>
          </div>
        </div>
      </div>
