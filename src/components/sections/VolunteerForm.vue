    ...
    <div class="container-custom">
      <div class="max-w-3xl mx-auto">
        ...
        <div class="text-center mb-12">
          <h2 class="text-3xl md:text-4xl font-bold text-brand mb-4">
            انضم كمتطوع
          </h2>
            ...
            <div class="space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  required
                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand focus:border-brand transition-all"
                >
              ...
              <div class="flex items-start gap-3">
                <input
                  ...
                  type="checkbox"
                  required
                  class="mt-1 w-4 h-4 text-brand focus:ring-brand rounded"
                />
                <label for="terms" class="text-sm text-gray-600">
                  أوافق على <a href="#" class="text-brand hover:text-gold font-semibold">الشروط والأحكام</a> 
                  و <a href="#" class="text-brand hover:text-gold font-semibold">سياسة الخصوصية</a>
                </label>
              </div>
